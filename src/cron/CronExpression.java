...
public final class CronExpression implements Serializable, Cloneable {
    ...
    public static void main(String[] args) throws ParseException {
        String cron = "1 0/5 5 17 * ?";
        CronExpression cronExpression1 = new CronExpression(cron);
       ...
       /* Instant instant = nextdate.toInstant();
        ...
        for (int i = 0; i < 10; i++) {
            Date date = cronExpression1.getNextValidTimeAfter(nextdate);
            System.out.println("第" + i +"次：" + date);
            nextdate = date;
        }
    }
}
